...
public class CommandQueue {
	 ...
	 * 
	 * Note: x, y is the center of the position, the 320, 240 offset is
	 ...
	 * 
	 * Only a subset of colors is supported:
	 * - red, green, blue, yellow, cyan, magenta, orange, black, white, gray
	 */
	public void setColor(Color color) {
		int c = 0;
		if (Color.red.equals(color)) c = 0;
		else if (Color.green.equals(color)) c = 1;
		else if (Color.blue.equals(color)) c = 2;
		else if (Color.yellow.equals(color)) c = 3;
		else if (Color.cyan.equals(color)) c = 4;
		else if (Color.magenta.equals(color)) c = 5;
		else if (Color.orange.equals(color)) c = 6;
		else if (Color.black.equals(color)) c = 7;
		else if (Color.white.equals(color)) c = 8;
		else if (Color.gray.equals(color)) c = 9;
